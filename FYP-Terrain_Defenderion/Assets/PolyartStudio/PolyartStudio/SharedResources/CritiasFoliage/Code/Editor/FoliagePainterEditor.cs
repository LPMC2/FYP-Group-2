...
#pragma warning restore CS0809 // Obsolete member overrides non-obsolete member
          ...
          /*  using (new ScopedLayout(() => { EditorGUILayout.BeginVertical("Box"); }, EBeginMode.BEGIN_VERTICAL))
            ...
            using (new ScopedLayout(() => { EditorGUILayout.BeginVertical("Box"); }, EBeginMode.BEGIN_VERTICAL))
            {
                ...
                painter.m_DrawNeighboringCells = EditorGUILayout.IntSlider(new GUIContent(
                    ...
                    painter.m_DrawNeighboringCells, 1, 10);
                ...
                painter.m_DrawGrassCellsDistance = EditorGUILayout.Slider(new GUIContent(
                    ...
                    painter.m_DrawGrassCellsDistance, 25, 600);
        ...
        void InspectorBrush()
        {
            ...
            paintParams.m_FoliageDensity = EditorGUILayout.Slider(
                ...
                paintParams.m_FoliageDensity, 0.05f, 4000f);
        ...
        void InspectorFoliageInfo()
        {
            ...
            foliageType.m_RenderInfo.m_LODTransition = 0.0f;
        ...
        void OnSceneGUI()
        {
            ...
            SceneView.RepaintAll();
            Color newColor = new Color(0f, 1f, 0f, 0.1f);
            Handles.color = newColor;
            Handles.zTest = UnityEngine.Rendering.CompareFunction.LessEqual;
            Handles.DrawSolidDisc(hit.point + hit.normal * 0.2f, hit.normal, radius);
            Color newColor2 = new Color(1f, 1f, 0f, 0.5f);
            Handles.color = newColor2;
            Handles.DrawWireDisc(hit.point + hit.normal * 0.2f, hit.normal, radius,2);
            Handles.DrawWireDisc(hit.point + hit.normal * 0.2f, hit.normal, radius/1.3f,2);
            Handles.DrawWireDisc(hit.point + hit.normal * 0.2f, hit.normal, radius/2,1);
            Handles.DrawWireDisc(hit.point + hit.normal * 0.2f, hit.normal, radius/4,1);
