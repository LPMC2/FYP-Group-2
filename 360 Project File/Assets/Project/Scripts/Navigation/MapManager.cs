...
public class MapManager : Singleton<MapManager>
{
    ...
    private Dictionary<MapLandmark, SphericalHelper> m_SphericalDict;

    public SphericalHelper this[MapLandmark mapLandmark] => m_SphericalDict[mapLandmark];
    ...
    public void SpawnFloor(MapFloor floor, float yOffset = 0f)
    {
        ...
        foreach (var landmark in floor.Landmarks)
        {
            ...
            m_SphericalDict.Add(landmark, spherical);
        }
    }
